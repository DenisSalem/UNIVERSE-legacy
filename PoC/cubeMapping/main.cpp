...
int main(int argc, char ** argv) {
  ...
  realmMinusezed.Noise(1,0,0);
  realmMinusezed.Noise(1,1,0);
  realmMinusezed.Noise(1,0,1);
  realmMinusezed.Noise(1,1,1);
  ...
  realmPlusix.Noise(1,1,0);
  realmPlusix.Noise(1,0,1);
  realmPlusix.Noise(1,1,1);

  // Décommenter pour avoir un terrain de sortie.
  //return 0;
  ...
  writePng(png,1536,2048,"terrain.png");
